...
public interface BingService {
    /*@GET("get_more/")
    Observable<BingBean> getBingData(@Query("api") String api, @Query("request_key") String request_key, @Query("page") int page,
 ...
 *   api=true&request_key=not_good_bomb&page=1&
 *   appkey=pear&channel=GooglePlay&
 *   clientversion=3.0.0&os=android&
 *   productid=a1&requesttime=1482104249989&
